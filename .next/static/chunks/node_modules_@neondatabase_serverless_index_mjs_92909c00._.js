...
ds');
    ...
    a(Jn, "wrtBigUInt64BE");
    h.prototype.writeBigUInt64LE = we(a(function(e) {
        let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
        return Zn(this, e, t, BigInt(0), BigInt("0xffffffffffffffff"));
    }, "w\
riteBigUInt64LE"));
    h.prototype.writeBigUInt64BE = we(a(function(e) {
        let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
...
writeInt32LE");
    ...
    h.prototype.writeBigInt64LE = we(a(function(e) {
        let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
        return Zn(this, e, t, -BigInt("0x\
8000000000000000"), BigInt("0x7fffffffffffffff"));
    }, "writeBigInt64LE"));
    h.prototype.writeBigInt64BE = we(a(function(e) {
        let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
...
out of bounds");
    ...
    Vt("ERR_OUT_OF_RANGE", function(r, e, t) {
        ...
        return Number.isInteger(t) && Math.abs(t) > 2 ** 32 ? i = $n(String(t)) : typeof t == "bigint" && (i = String(t), (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (i = $n(i)), i += "n"), n += " It must be ".concat(e, ". Received ").concat(i), n;
    }, RangeError);
    function $n(r) {
...
var b, v, x, d, m, p = G(()=>{
    "use strict";
    var _globalThis_setImmediate, _globalThis_clearImmediate, _globalThis_process;
    b = globalThis, v = (_globalThis_setImmediate = globalThis.setImmediate) !== null && _globalThis_setImmediate !== void 0 ? _globalThis_setImmediate : (r)=>setTimeout(r, 0), x = (_globalThis_clearImmediate = globalThis.clearImmediate) !== null && _globalThis_clearImmediate !== void 0 ? _globalThis_clearImmediate : (r)=>clearTimeout(r), d = typeof globalThis.Buffer == "function" && typeof globalThis.Buffer.allocUnsafe == "function" ? globalThis.Buffer : ii().Buffer, m = (_globalThis_process = globalThis.process) !== null && _globalThis_process !== void 0 ? _globalThis_process : {};
    var _m_env;
...
trict";
    ...
    yi = /^[^.]+\./, S = class S extends mi.EventEmitter {
        static get poolQueryViaFetch() {
            var _S_opts_poolQueryViaFetch;
            return (_S_opts_poolQueryViaFetch = S.opts.poolQueryViaFetch) !== null && _S_opts_poolQueryViaFetch !== void 0 ? _S_opts_poolQueryViaFetch : S.defaults.poolQueryViaFetch;
        }
        static set poolQueryViaFetch(t) {
            S.opts.poolQueryViaFetch = t;
        }
        static get fetchEndpoint() {
            var _S_opts_fetchEndpoint;
            return (_S_opts_fetchEndpoint = S.opts.fetchEndpoint) !== null && _S_opts_fetchEndpoint !== void 0 ? _S_opts_fetchEndpoint : S.defaults.fetchEndpoint;
        }
        ...
        static get fetchFunction() {
            var _S_opts_fetchFunction;
            return (_S_opts_fetchFunction = S.opts.fetchFunction) !== null && _S_opts_fetchFunction !== void 0 ? _S_opts_fetchFunction : S.defaults.fetchFunction;
        }
        static set fetchFunction(t) {
            S.opts.fetchFunction = t;
        }
        static get webSocketConstructor() {
            var _S_opts_webSocketConstructor;
            return (_S_opts_webSocketConstructor = S.opts.webSocketConstructor) !== null && _S_opts_webSocketConstructor !== void 0 ? _S_opts_webSocketConstructor : S.defaults.webSocketConstructor;
        }
        ...
        get webSocketConstructor() {
            ...
            return (_this_opts_webSocketConstructor = this.opts.webSocketConstructor) !== null && _this_opts_webSocketConstructor !== void 0 ? _this_opts_webSocketConstructor : S.webSocketConstructor;
        }
        ...
        static get wsProxy() {
            var _S_opts_wsProxy;
            return (_S_opts_wsProxy = S.opts.wsProxy) !== null && _S_opts_wsProxy !== void 0 ? _S_opts_wsProxy : S.defaults.wsProxy;
        }
        ...
        get wsProxy() {
            ...
            return (_this_opts_wsProxy = this.opts.wsProxy) !== null && _this_opts_wsProxy !== void 0 ? _this_opts_wsProxy : S.wsProxy;
        }
        set wsProxy(t) {
            this.opts.wsProxy = t;
        }
        static get coalesceWrites() {
            var _S_opts_coalesceWrites;
            return (_S_opts_coalesceWrites = S.opts.coalesceWrites) !== null && _S_opts_coalesceWrites !== void 0 ? _S_opts_coalesceWrites : S.defaults.coalesceWrites;
        }
        ...
        get coalesceWrites() {
            ...
            return (_this_opts_coalesceWrites = this.opts.coalesceWrites) !== null && _this_opts_coalesceWrites !== void 0 ? _this_opts_coalesceWrites : S.coalesceWrites;
        }
        set coalesceWrites(t) {
            this.opts.coalesceWrites = t;
        }
        static get useSecureWebSocket() {
            var _S_opts_useSecureWebSocket;
            return (_S_opts_useSecureWebSocket = S.opts.useSecureWebSocket) !== null && _S_opts_useSecureWebSocket !== void 0 ? _S_opts_useSecureWebSocket : S.defaults.useSecureWebSocket;
        }
        ...
        get useSecureWebSocket() {
            ...
            return (_this_opts_useSecureWebSocket = this.opts.useSecureWebSocket) !== null && _this_opts_useSecureWebSocket !== void 0 ? _this_opts_useSecureWebSocket : S.useSecureWebSocket;
        }
        set useSecureWebSocket(t) {
            this.opts.useSecureWebSocket = t;
        }
        static get forceDisablePgSSL() {
            var _S_opts_forceDisablePgSSL;
            return (_S_opts_forceDisablePgSSL = S.opts.forceDisablePgSSL) !== null && _S_opts_forceDisablePgSSL !== void 0 ? _S_opts_forceDisablePgSSL : S.defaults.forceDisablePgSSL;
        }
        ...
        get forceDisablePgSSL() {
            ...
            return (_this_opts_forceDisablePgSSL = this.opts.forceDisablePgSSL) !== null && _this_opts_forceDisablePgSSL !== void 0 ? _this_opts_forceDisablePgSSL : S.forceDisablePgSSL;
        }
        set forceDisablePgSSL(t) {
            this.opts.forceDisablePgSSL = t;
        }
        static get disableSNI() {
            var _S_opts_disableSNI;
            return (_S_opts_disableSNI = S.opts.disableSNI) !== null && _S_opts_disableSNI !== void 0 ? _S_opts_disableSNI : S.defaults.disableSNI;
        }
        ...
        get disableSNI() {
            ...
            return (_this_opts_disableSNI = this.opts.disableSNI) !== null && _this_opts_disableSNI !== void 0 ? _this_opts_disableSNI : S.disableSNI;
        }
        set disableSNI(t) {
            this.opts.disableSNI = t;
        }
        static get disableWarningInBrowsers() {
            var _S_opts_disableWarningInBrowsers;
            return (_S_opts_disableWarningInBrowsers = S.opts.disableWarningInBrowsers) !== null && _S_opts_disableWarningInBrowsers !== void 0 ? _S_opts_disableWarningInBrowsers : S.defaults.disableWarningInBrowsers;
        }
        static set disableWarningInBrowsers(t) {
            S.opts.disableWarningInBrowsers = t;
        }
        get disableWarningInBrowsers() {
            var _this_opts_disableWarningInBrowsers;
            return (_this_opts_disableWarningInBrowsers = this.opts.disableWarningInBrowsers) !== null && _this_opts_disableWarningInBrowsers !== void 0 ? _this_opts_disableWarningInBrowsers : S.disableWarningInBrowsers;
        }
        set disableWarningInBrowsers(t) {
            this.opts.disableWarningInBrowsers = t;
        }
        static get pipelineConnect() {
            var _S_opts_pipelineConnect;
            return (_S_opts_pipelineConnect = S.opts.pipelineConnect) !== null && _S_opts_pipelineConnect !== void 0 ? _S_opts_pipelineConnect : S.defaults.pipelineConnect;
        }
        ...
        get pipelineConnect() {
            ...
            return (_this_opts_pipelineConnect = this.opts.pipelineConnect) !== null && _this_opts_pipelineConnect !== void 0 ? _this_opts_pipelineConnect : S.pipelineConnect;
        }
        ...
        static get subtls() {
            var _S_opts_subtls;
            return (_S_opts_subtls = S.opts.subtls) !== null && _S_opts_subtls !== void 0 ? _S_opts_subtls : S.defaults.subtls;
        }
        static set subtls(t) {
            S.opts.subtls = t;
        }
        get subtls() {
            ...
            return (_this_opts_subtls = this.opts.subtls) !== null && _this_opts_subtls !== void 0 ? _this_opts_subtls : S.subtls;
        }
        set subtls(t) {
            this.opts.subtls = t;
        }
        static get pipelineTLS() {
            var _S_opts_pipelineTLS;
            return (_S_opts_pipelineTLS = S.opts.pipelineTLS) !== null && _S_opts_pipelineTLS !== void 0 ? _S_opts_pipelineTLS : S.defaults.pipelineTLS;
        }
        ...
        get pipelineTLS() {
            ...
            return (_this_opts_pipelineTLS = this.opts.pipelineTLS) !== null && _this_opts_pipelineTLS !== void 0 ? _this_opts_pipelineTLS : S.pipelineTLS;
        }
        set pipelineTLS(t) {
            this.opts.pipelineTLS = t;
        }
        static get rootCerts() {
            var _S_opts_rootCerts;
            return (_S_opts_rootCerts = S.opts.rootCerts) !== null && _S_opts_rootCerts !== void 0 ? _S_opts_rootCerts : S.defaults.rootCerts;
        }
        ...
        get rootCerts() {
            ...
            return (_this_opts_rootCerts = this.opts.rootCerts) !== null && _this_opts_rootCerts !== void 0 ? _this_opts_rootCerts : S.rootCerts;
        }
        set rootCerts(t) {
...
handleWebSocketOpen"), o = a(function(c) {
                ...
                c.binaryType = "arraybuffer", c.addEventListener("error", (f)=>{
                    _this.emit("error", f), _this.emit("close");
            ...
            try {
                ...
                fetch(f, {
                    ...
                    this.emit("error", new Error("All attempts to open a WebSocket to connect to the database failed. Please refer to https://github.com/neondatabase/serverless/blob/main/CONFIG.md#websocketconstructor-typeof-websocket--undefined. Details: ".concat(y))), this.emit("close");
                });
            }
        }
        async startTls(t) {
...
ithub.com/neondatabase/serverless/blob/main/CONFIG.md for more information.");
        ...
        write(t) {
            ...
            let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : d.alloc(0), n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "utf8", i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : ()=>{};
...
writeBuffer");
    ...
    a(S, "Socket"), E(S, "defaults", {
        ...
        fetchEndpoint: a((t, n, i)=>{
            let s;
            return (i === null || i === void 0 ? void 0 : i.jwtAuth) ? s = t.replace(yi, "apiauth.") : s = t.replace(yi, "api."), "https://" + s + "/sql";
        }, "fetchEndpoint"),
...
var qs = T((Bh, Os)=>{
    ...
    var { EventEmitter: dc } = ge(), Us = Ms(), Ds = rt(), kr = class kr extends dc {
        ...
        submit(e) {
            ...
            return this.text && t && this.text !== t ? new Error("Prepared statements must be unique - '".concat(this.name, "' was used for a different statement")) : this.values && !Array.isArray(this.values) ? new Error("Query val\
...
writeValues"), Ec = a(function() {
    ...
    }, "cstringMessage"), Ic = F.addCString("P").flush(68), Tc = F.addCString("S").flush(68), Pc = a((r)=>r.name ? dn(68, "".concat(r.type).concat(r.name || "")) : r.type === "P" ? Ic : Tc, "describe"), Bc = a((r)=>{
...
enticationOk message type " + i);
        ...
        constructor(e){
            if (this.buffer = $s, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new qc.BufferReader, (e === null || e === void 0 ? void 0 : e.mode) === "binary") throw new Error("Binary mod\
e not supported yet");
...
var He, wt;
function Ea(r) {
    let { alphabet: e, scratchArr: t } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    ...
    toParameterizedQuery() {
        ...
        for(let i = 0, s = t.length; i < s; i++)if (e.query += t[i], i < n.length) {
            ...
            if (o instanceof Ge) e.query += o.sql;
                ...
                var _o_queryData_params;
                if ((_o_queryData_params = o.queryData.params) === null || _o_queryData_params === void 0 ? void 0 : _o_queryData_params.length) throw new Error("This query is not composable");
...
areQuery");
function cs(r) {
    let { arrayMode: e, fullResults: t, fetchOptions: n, isolationLevel: i, readOnly: s, deferrable: o, authToken: u, disableWarningInBrowsers: c } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
th value placeholders ($1, $2, etc.), use sql.query("SELECT $1", [value], options).');
    ...
    a(D, "templateFn"), D.query = (P, I, w)=>new Ce(Y, {
        ...
        let w = P.map((W)=>W.queryData), Z = P.map((W)=>{
            var _W_opts;
            return (_W_opts = W.opts) !== null && _W_opts !== void 0 ? _W_opts : {};
        });
        return Y(w, Z, I);
    };
    async function Y(P, I, w) {
        ...
        } : ss(P), X = n !== null && n !== void 0 ? n : {}, se = e !== null && e !== void 0 ? e : !1, oe = t !== null && t !== void 0 ? t : !1, R = i, j = s, le = o;
        ...
        let de = u;
        !Array.isArray(I) && (I === null || I === void 0 ? void 0 : I.authToken) !== void 0 && (de = I.authToken);
...
e",
        ...
        _e && (fe.Authorization = "Bearer ".concat(_e)), Array.isArray(P) && (R !== void 0 && (fe["Neon-Batch-Isolation-Level"] = R), j !== void 0 && (fe["Neon-Batch-Read-Only"] = String(j)), le !== void 0 && (fe["Neon-Batch-Deferrable"] = String(le))), c || ce.disableWarningInBrowsers || bt();
        let ye;
        try {
            ye = await (W !== null && W !== void 0 ? W : fetch)(We, {
                method: "POST",
            ...
            let M = new be("Error connecting to database: ".concat(ee));
...
lt format");
                return M.map(($, me)=>{
                    var _I_me, _Ot_arrayMode, _Ot_fullResults;
                    let Ot = (_I_me = I[me]) !== null && _I_me !== void 0 ? _I_me : {}, vo = (_Ot_arrayMode = Ot.arrayMode) !== null && _Ot_arrayMode !== void 0 ? _Ot_arrayMode : se, xo = (_Ot_fullResults = Ot.fullResults) !== null && _Ot_fullResults !== void 0 ? _Ot_fullResults : oe;
                    return os($, {
                        arrayMode: vo,
                        fullResults: xo,
                        types: Ot.types
                ...
                var _M_arrayMode, _M_fullResults;
                let M = I !== null && I !== void 0 ? I : {}, $ = (_M_arrayMode = M.arrayMode) !== null && _M_arrayMode !== void 0 ? _M_arrayMode : se, me = (_M_fullResults = M.fullResults) !== null && _M_fullResults !== void 0 ? _M_fullResults : oe;
                return os(ee, {
                    arrayMode: $,
                    fullResults: me,
                    types: M.types
            ...
            if (ee === 400) {
                ...
                var _M_me;
                for (let me of Ru)$[me] = (_M_me = M[me]) !== null && _M_me !== void 0 ? _M_me : void 0;
                throw $;
            } else {
                let M = await ye.text();
                throw new be("Server error (HTTP status ".concat(ee, "): ").concat(M));
            }
        }
    }
...
var Ce = dr;
function os(r, param) {
    let { arrayMode: e, fullResults: t, types: n } = param;
...
async function Fu(r) {
    ...
    if (typeof r == "function") try {
        ...
        throw e instanceof Error && (t = new be("Error getting auth token: ".concat(e.message))), t;
    }
}
a(Fu, "getAuthToken");
p();
...
e SSL in the Postgres connection parameters or set forceDisablePgSSL = true.");
        var _m_env_USER;
        let i = typeof this.config != "string" && ((_this_config = this.config) === null || _this_config === void 0 ? void 0 : _this_config.host) !== void 0 || typeof this.config != "string" && ((_this_config1 = this.config) === null || _this_config1 === void 0 ? void 0 : _this_config1.connectionString) !== void 0 || m.env.PGHOST !== void 0, s = (_m_env_USER = m.env.USER) !== null && _m_env_USER !== void 0 ? _m_env_USER : m.env.USERNAME;
...
var Un = class Un extends go.Pool {
    ...
    query(t, n, i) {
        ...
        try {
            var _this_options;
            var _ref;
            let o = new bo.default(this.options), u = encodeURIComponent, c = encodeURI, l = "postgresql://".concat(u(o.user), ":").concat(u(o.password), "@").concat(u(o.host), "/").concat(c(o.database)), f = typeof t == "string" ? t : t.text, y = (_ref = n !== null && n !== void 0 ? n : t.values) !== null && _ref !== void 0 ? _ref : [];
            var _t_types;
            cs(l, {
                fullResults: !0,
...
//# sourceMappingURL=node_modules_%40neondatabase_serverless_index_mjs_92909c00._.js.map