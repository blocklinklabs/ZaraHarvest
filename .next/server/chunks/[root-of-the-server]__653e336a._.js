module.exports = [
"[project]/.next-internal/server/app/api/loans/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/lib/contract.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getAgriYieldContract(provider) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(CONTRACT_ADDRESS, CONTRACT_ABI, provider);
}
...
function getServerContractHelper() {
    ...
    const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].JsonRpcProvider(process.env.HEDERA_RPC_URL);
    const signer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Wallet(process.env.CONTRACT_OWNER_PRIVATE_KEY, provider);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$contract$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/contract.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db/services.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__ = __turbopack_context__.i("[project]/node_modules/ethers/lib.esm/ethers.js [app-route] (ecmascript) <export * as ethers>");
;
;
...
async function GET(request) {
    try {
        ...
        // Get user's loans
        const userLoans = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLoansByUserId"])(user.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
async function POST(request) {
    try {
        ...
        const { walletAddress, collateralTokenId, amount, collateralPredictionId } = body;
        ...
        const availableCollateral = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAvailableCollateralByUserId"])(user.id);
        const selectedCollateral = availableCollateral.find((token)=>token.id === collateralTokenId);
        ...
        const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].BrowserProvider(window.ethereum);
        const signer = await provider.getSigner();
        const contractHelper = new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$contract$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AgriYieldHelper"](signer);
        // Request loan from smart contract
        const loanAmount = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].parseEther(amount.toString());
        const blockchainResult = await contractHelper.requestLoan(parseInt(collateralPredictionId), loanAmount);
        ...
        const loan = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLoanWithBlockchain"])(loanData);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: {
                id: loan.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__653e336a._.js.map