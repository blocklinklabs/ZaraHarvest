module.exports = [
"[project]/.next-internal/server/app/api/harvest-tokens/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/harvest-tokens/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const quantity = Math.floor(parseFloat(amount) * 100); // Convert to kg (scaled by 100)
        const blockchainResult = await contractHelper.mintHarvestToken(cropType, quantity, qualityGrade, metadataURI);
        if (!blockchainResult.success) {
            throw new Error("Blockchain transaction failed");
        }
        // Calculate tokenized amount (1 ton = 10 tokens)
        const tokenizedAmount = parseFloat(amount) * 10;
        // Store harvest token in database
        const tokenData = {
            userId: user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e6d0764d._.js.map