module.exports = [
"[project]/.next-internal/server/app/api/user/onboard/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/user/onboard/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        const { walletAddress, fullName, email, phone, location, country, cropType, farmSize, farmingExperience, additionalInfo } = await request.json();
        if (!walletAddress) {
        ...
        const existingUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserByWalletAddress"])(walletAddress);
        if (existingUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$services$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUser"])(userData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__061fd2e0._.js.map